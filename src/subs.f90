...
!read in data
        ...
        real, intent(IN):: layer_nzg
         ...
         !set layer bottom depths
            ...
            !sc_dep=0.002 !20um sc
            !sc_dep= 0.0015 !15um sc
            !sc_dep= 0.001 !10um sc
            !sc_dep= 0. !0um sc


            !30um stratum corneum
            sc_dep=0.003
            e_dep=0.0084 + 0.001
            m_dep=0.0094 + 0.001
            ba_dep=0.0104 + 0.001
            ...
            !15um stratum corneum
            !sc_dep=0.0015
            !e_dep=0.0084 - 0.0005
            !m_dep=0.0094 - 0.0005
            !ba_dep=0.0104 - 0.0005
            !d_dep=0.21 - 0.0005

            !10um stratum corneum
            !sc_dep=0.001
            !e_dep=0.0084 - 0.001
            !m_dep=0.0094 - 0.001
            !ba_dep=0.0104 - 0.001
	...
	do j=1,nyg
 	...
 	!print*, e+0.25, m+0.25, ba+0.25 	
 			 
 	         end do
 	end do
 end do
 
! print*, sc_kappa, e_kappa, m_kappa, b_kappa, d_kappa, h_kappa
