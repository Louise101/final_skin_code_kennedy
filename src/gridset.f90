MODULE gridset_mod
  ...
  !  *****  30um sc *****************************
          ...
          do i = 302, 401
             zface(i) =zface(301)+(i - 301) * 2. * zmax/e_nzg

          end do

            do i = 402, 501
             zface(i) = zface(401)+(i - 401) * 2. * zmax/m_nzg

          end do

          do i = 502, 601
              zface(i) = zface(501)+(i - 501) * 2. * zmax/b_nzg
          end do

          do i = 602, 751
              zface(i) =zface(601)+(i - 601) * 2. * zmax/d_nzg
          end do

          do i = 752, 900+1
              zface(i) = zface(751)+(i - 751) * 2. * zmax/h_nzg
          end do
        ...
        !do i = 152, 251
        !   zface(i) =zface(151)+(i - 151) * 2. * zmax/e_nzg

        !end do

      !    do i = 252, 351
      !     zface(i) = zface(251)+(i - 251) * 2. * zmax/m_nzg

      !  end do

      !  do i = 352, 451
      !      zface(i) = zface(351)+(i - 351) * 2. * zmax/b_nzg
      !  end do

      !  do i = 452, 601
      !      zface(i) =zface(451)+(i - 451) * 2. * zmax/d_nzg
      !  end do

      !  do i = 602, 750+1
      !      zface(i) = zface(601)+(i - 601) * 2. * zmax/h_nzg
      !  end do
      ...
      !do i = 102, 201
      !   zface(i) =zface(101)+(i - 101) * 2. * zmax/e_nzg

      !end do

    !    do i = 202, 301
    !     zface(i) = zface(201)+(i - 201) * 2. * zmax/m_nzg

    !  end do

    !  do i = 302, 401
    !      zface(i) = zface(301)+(i - 301) * 2. * zmax/b_nzg
    !  end do

    !  do i = 402, 551
    !      zface(i) =zface(401)+(i - 401) * 2. * zmax/d_nzg
    !  end do

    !  do i = 552, 700+1
    !      zface(i) = zface(551)+(i - 551) * 2. * zmax/h_nzg
    !  end do

    !***********0um sc********************

    !do i = 1, 101
    !   zface(i) =zface(1)+(i -1) * 2. * zmax/e_nzg

    !end do

  !    do i = 102, 201
  !     zface(i) = zface(101)+(i - 101) * 2. * zmax/m_nzg

  !  end do

  !  do i = 202, 301
  !      zface(i) = zface(201)+(i - 201) * 2. * zmax/b_nzg
  !  end do

  !  do i = 302, 451
  !      zface(i) =zface(301)+(i - 301) * 2. * zmax/d_nzg
  !  end do

  !  do i = 452, 600+1
  !      zface(i) = zface(451)+(i - 451) * 2. * zmax/h_nzg
  !  end do
